namespace EverLite
{
    ...
    /// <summary>
    /// Manages the game logic for the GameOverScene.
    /// </summary>
    public class GameOverComponent : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public GameOverComponent(EverLite game)
            : base(game)
        {
            this.game = game;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (this.game.NewKey(Keys.Up) || this.game.NewKey(this.game.playerSettings.MoveUp))
                SelectUp(this.listName);
            if (this.game.NewKey(Keys.Down) || this.game.NewKey(this.game.playerSettings.MoveDown))
                SelectDown(this.listName);
            if (this.game.NewKey(Keys.Left) || this.game.NewKey(this.game.playerSettings.MoveLeft))
                SelectLeft(this.listName);
            if (this.game.NewKey(Keys.Right) || this.game.NewKey(this.game.playerSettings.MoveRight))
