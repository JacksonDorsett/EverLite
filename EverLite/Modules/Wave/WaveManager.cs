...
namespace EverLite
{
    ...
    public class WaveManager
    {
        ...
        public void Initialize()
        {
            ...
            this.AddWave(new Wave(this.enemies, spawners, new Modules.Wave.EnemyFactory(SpriteLoader.LoadSprite("enemy2"), linear, 4), new BulletSpawner(linear, 4, new LinearPattern(BulletManager.Instance.EnemyBullets, SpriteLoader.LoadSprite("enemy1"), .1f, 20, 2000)), 1000, 10, 0));
            this.AddWave(new Wave(this.enemies, spawners, new Modules.Wave.EnemyFactory(SpriteLoader.LoadSprite("enemy1"), curved, 4), new BulletSpawner(curved, 4, new LinearPattern(BulletManager.Instance.EnemyBullets, SpriteLoader.LoadSprite("enemy2"), .1f, 20, 2000)), 1000, 10, 0));
        }
